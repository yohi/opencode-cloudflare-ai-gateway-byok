...
import { gatewayConfig, gatewayMetadata, gatewayOptions, type ExtendedAiGatewayOptions } from "./env.js"
  ...
  Effect.gen(function* () {
    yield* ctx.aisdk.sdk((evt) =>
      Effect.gen(function* () {
        ...
        const options: ExtendedAiGatewayOptions = gatewayOptions(evt.options, metadata)
